...
from denseflow.data.loaders.image import CIFAR10, ImageNet32, ImageNet64, SVHN, MNIST, CIFAR10Supervised, SVHNSupervised, CIFAR100Supervised, CelebA, CUB200

dataset_choices = {'cifar10', 'cifar10sup', 'cifar100sup', 'imagenet32', 'imagenet64', 'svhn', 'svhnsup', 'mnist', 'celeba', 'cub200'}
...
def get_data(args):
    ...
    if args.dataset == 'cifar10':
        ...
        dataset = CUB200(num_bits=args.num_bits, pil_transforms=pil_transforms)
...
def get_data_shape(dataset):
    if dataset == 'cifar10' or dataset == 'cifar10sup' or dataset == 'cifar100sup' or dataset == 'cifar100':
        return (3,32,32)
    elif dataset == 'imagenet32':
        return (3,32,32)
    elif dataset == 'imagenet64' or dataset == 'celeba' or dataset == 'cub200' or dataset == 'flowers':
        return (3,64,64)
