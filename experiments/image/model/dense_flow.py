...
class DenseFlow(Flow):
    ...
    def __init__(self, data_shape=(3, 32, 32), block_config=[2, 4, 3], layers_config=[2, 2, 2],
                 layer_mid_chnls=[6, 12, 20], growth_rate=None, num_bits=8, checkpointing=True,
                 base_dist=True):
        ...
        base_dist = ConvNormal2d(current_shape) if base_dist else None
        super(DenseFlow, self).__init__(base_dist=base_dist,
